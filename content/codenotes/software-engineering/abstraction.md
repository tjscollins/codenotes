...
This is, of course, pretty abstract and general in and of itself.  But consider how this definition applies to the examples above.  In the case of the spoon, our abstract spoon can be defined as an object having a handle connected to a shallow bowl that is used for scooping liquids or quantities of small objects (like grains of sugar).  The virtual spoon in *The Matrix* clearly fulfills this abstraction.  It is a spoon even though it doesn't really exist.
...
I stated earlier that abstraction might be the single most important concept in software engineering.  That wasn't hyperbole.  Even the most basic computer systems are staggeringly complicated things whose inner workings are far, far beyond any human's ability to mentally track and follow completely.  Without abstraction we wouldn't be able to work with computers at all.
...
Writing a computer program is not substantially different from describing your morning routine.  In writing a computer program we are, more or less, simply writing instructions for the computer, and, just like when describing the instructions for our morning routine, we are free to choose an appropriate level of abstraction for that description.  We could write the program at the level of the sequence of voltages to be sent to each pin of the CPU--the binary 1s and 0s of machine language, or we could write the program in a high level declarative language that hides all details of implementation, or we could choose some level of abstractions in-between.  Selecting the appropriate level of abstraction for our goals is our primary tool for managing the complexity of software development.
...
Let's start with imperative programming in a high-level language (e.g. Java, C++, Python, etc.).  For most software developers this is this lowest level of abstraction you'll ever work at outside of a university class that uses assembly.  As for what I mean by *imperative programming*, consider the following example (in Javascript):
